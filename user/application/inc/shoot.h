...
class Shoot
{
   public:
    ...
    Pid fric_speed_[2];   /**< Array of PID controllers for friction motors' speed control. */
    Pid trigger_pos_;     /**< PID controller for trigger position control. */
    Pid trigger_speed_;   /**< PID controller for trigger speed control. */
